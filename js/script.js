...
$(function(){
    ...
    $("#more-button-2-2").on("click", function(){


        $("#howitworks-more-2-2").addClass("show");
        $("#more-button-2-2").addClass("buttonHide");
        $("#exit-button-2-2").removeClass("exit-buttonHide");
    ...
    $("#exit-button-2-2").on("click", function(){


        $("#howitworks-more-2-2").removeClass("show");
        $("#more-button-2-2").removeClass("buttonHide");
        $("#exit-button-2-2").addClass("exit-buttonHide");
    ...
    $("#more-button-4-4").on("click", function(){


        $("#howitworks-more-4-4").addClass("show");
        $("#more-button-4-4").addClass("buttonHide");
        $("#exit-button-4-4").removeClass("exit-buttonHide");
    ...
    $("#exit-button-4-4").on("click", function(){


        $("#howitworks-more-4-4").removeClass("show");
        $("#more-button-4-4").removeClass("buttonHide");
        $("#exit-button-4-4").addClass("exit-buttonHide");
